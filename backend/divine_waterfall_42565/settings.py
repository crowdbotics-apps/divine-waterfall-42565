"""
Django settings for divine_waterfall_42565 project.
...
ROOT_URLCONF = 'divine_waterfall_42565.urls'
...
WSGI_APPLICATION = 'divine_waterfall_42565.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "divine_waterfall_42565 API",
    "DESCRIPTION": "API documentation for divine_waterfall_42565 App",
    "VERSION": "v1",
}
